 ...
 * @param {string} opts.coin[='acm'] - The coin for this wallet (acm, bch).
 ...
 * @param {string} opts.coin[='acm'] - The expected coin for this wallet (acm, bch).
...
WalletService.prototype.savePreferences = function(opts, cb) {
  ...
  var preferences = [{
    ...
    name: 'unit',
    isValid: function(value) {
      return _.isString(value) && _.contains(['acm', 'bit'], value.toLowerCase());
    },
  }];
 ...
 * @param {Object} opts
 * @param {String} [opts.coin='acm'] (optional)
 ...
 * @param {Object} opts
 * @param {string} [opts.coin = 'acm'] - The coin to estimate fee levels from.
...
WalletService.prototype._checkTx = function(txp) {
  ...
  try {
    ...
    self.logw('Error building AcmCore transaction', ex);
    return ex;
  }
 ...
 * @param {Object} opts
 * @param {string} [opts.coin = 'acm'] - The coin for this transaction.
